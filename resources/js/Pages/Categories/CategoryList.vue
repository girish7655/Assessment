...
// Computed property to filter categories based on search input
...
const deleteCategory = (id) => {
    if (confirm("Are you sure you want to delete this category?")) {
        router.delete(route('categories.destroy', id), {
            onSuccess: () => {
                successMessage.value = page.props.flash?.success || "category deleted successfully!";
            },
            onError: () => {
                errorMessage.value = page.props.flash?.error || "Failed to delete category. Please try again.";
            }
        });
    }
};
            ...
            <div class="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
                ...
                <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6">
                    <div class="flex flex-col sm:flex-row sm:items-center space-y-2 sm:space-y-0 sm:space-x-6">
                        <h1 class="text-2xl sm:text-3xl font-bold text-gray-900">Categories List</h1>
                ...
                <div v-else class="text-center py-12">
                    <p class="text-red-500 text-lg font-medium">No categories available.</p>
                </div>
            </div>
        </div>
    </AuthenticatedLayout>
